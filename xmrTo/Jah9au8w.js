...
// curl 'https://monerohash.com/api/stats_address?address=47HtbDvpVQwDsiegiDZqYxcQEDZtj3DGxHcdeaqem4jqQxkBQtpxgopUZ5oVg2HaWfTjGye2MBZZJTPvDpeL1Koq5ZtaFH1&longpoll=false'

const minexmr = co.wrap(function*(address) {
  let obj = { address: address };
  let stringified = queryString.stringify(obj);
  let fullUrl = urljoin(
    "https://monerohash.com/api",
    "stats_address",
    "?" + stringified
  );
